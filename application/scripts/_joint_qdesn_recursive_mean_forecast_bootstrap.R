...
for (path in c(
  ...
  "joint_qdesn_posterior_contract.R", "joint_qdesn_simulation_readiness.R",
  "joint_qdesn_simulation_fixtures.R", "joint_qdesn_simulation_validation.R",
  "joint_qdesn_mcmc_readiness.R", "latent_path_design.R",
...
app_joint_recursive_default_root <- function() app_path(
  "application/cache/joint_qdesn_recursive_mean_forecast_jerez_20260924"
)

app_joint_recursive_default_source <- function() app_path(
