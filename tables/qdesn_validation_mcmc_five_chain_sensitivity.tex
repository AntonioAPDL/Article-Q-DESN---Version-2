% Generated from the frozen five-chain independent-validation sensitivity bundle.
\begin{table}[!htbp]
\centering
\small
...
\midrule
Q--DESN \(\AL\)--\(\RHS\)
  & Primary metric envelope & 2.176 & 2.361 & \textbf{3.297} \\
  & Five-chain coherent design & \textbf{1.993} & \textbf{2.323} & 3.309 \\
\addlinespace
Q--DESN \(\exAL\)--\(\RHS\)
  & Primary metric envelope & 1.710 & 2.709 & 3.333 \\
...
the metric-wise envelopes in the main article's Gaussian MCMC table;
