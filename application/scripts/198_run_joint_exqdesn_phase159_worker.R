...
args <- app_parse_args(list(freeze_dir = "application/cache/joint_qdesn_phase159_split_rhs_calibration_freeze_20260804", worker_id = NA_integer_))
...
result <- app_joint_exqdesn_phase159_run_worker(freeze_dir, worker_id)
