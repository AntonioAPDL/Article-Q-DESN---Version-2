...
args <- app_parse_args(list(freeze_dir = app_joint_exqdesn_phase160_default_freeze_dir()))
freeze_dir <- args[["freeze-dir"]] %||% args$freeze_dir
print(app_joint_exqdesn_phase160_health(freeze_dir)$summary, row.names = FALSE)
