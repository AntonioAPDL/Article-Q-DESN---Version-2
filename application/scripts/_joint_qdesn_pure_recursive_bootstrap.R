...
repo_root <- if (!is.na(script_arg)) normalizePath(file.path(dirname(normalizePath(script_arg)), "..", "..")) else normalizePath(getwd())
...
for (path in c(
  ...
  "latent_path_vb_al.R", "joint_qvp_qdesn.R", "joint_qdesn_posterior_contract.R",
